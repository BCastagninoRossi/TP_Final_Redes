...
char *test_buffers_arr[CASES][ARRAY_SIZE] = {
  {
    ...
    "agent_Paul�" "\x02" "2024-11-05 20:08:21" "\x02" "Hi Amy, what can I do for you?""\x04",
  ...
  },
  {
    ...
    "agent_Paul" "\x02" "2024-11-05 20:08:21" "\x02" "Hi Amy, what can I do for you?""\x04",
    /* write 2:  2 pdu in one write */
    "client_Amytienemuchoscaracteresyesmuygrande, no hay problema, hey sister, assdsfaskdjfnaksdjnckassakdjbasdbcvjkasbc" "\x02" "2024-11-05 20:08:01" "\x02" "There is an issue with my paid subscription service of Netflix. I can't play any content on any device""\x04",
  },
